...
?>
    ...
    <?php 
        ...
        <div class="card mb-3 col-4 offset-1" >
            <img class="card-img-top" height="250px" src="./assets/images/<?= $valueV->getImage(); ?>"  alt="Card image cap">
            ...
            href="./index.php?action=recapitulatif&id=<?= $valueV->getIdVehicule(); ?>&prix=<?= $valueV->getPrix(); ?>&modele=<?= $valueV->getModele(); ?>" class="btn btn-info col">Acheter à partir de  <div><b><?= $valueV->getPrix(); ?>€</b></div>
            </a>
